...
public final class TypeList extends NonScopeType
{
    ...
    public SubstMap subsume(final Loc loc, final Type type, final TypeEnv env)
    {
        ...
        // currently it's doing a offset sublist unification
        // should it be offset n? or any order?
        // A: they're different kinds of constraints.
        // tuple should be offset 0
        // variant can be anywhere and is automatically in the right order.
        //
