...
/**
 * Try inlining calls to {@link runtime.intrinsic.FNeg}.
 */
public class FNegInliner implements Inliner
{
    public String tryInlining(
        final ApplyTerm apply, final StatementFormatter fmt,
        final boolean stmtsOkay)
    {
        final String expr = "-(" + fmt.formatTermAs(apply.getArg(), double.class) + ")";
