...
public class ASTBuilder
{
    ...
    */
     ...
     *
     */
    public static Type namedVarType(final Loc loc, final List<Pair<Term, Type>> pairs)
    {
        return Types.var(loc, mapFromPairs(pairs, true));
    }

    /**
     *
     */
    public static Type posVarType(final Loc loc, final Type head, final List<Type> tail)
    {
        return Types.sel(loc, cons(head, tail));
    }
