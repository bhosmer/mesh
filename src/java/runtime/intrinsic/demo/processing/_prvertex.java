 ...
 */
public final class _prvertex extends IntrinsicLambda
{
    public static final _prvertex INSTANCE = new _prvertex(); 
    public static final String NAME = "prvertex";
    ...
    public static Tuple invoke(final double x, final double y)
    {
        ...
        {
            Processing.INSTANCE.vertex((float)x, (float)y);
        }
