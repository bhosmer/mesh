 ...
 */
public final class _prdirectionallight extends IntrinsicLambda
{
    public static final _prdirectionallight INSTANCE = new _prdirectionallight(); 
    public static final String NAME = "prdirectionallight";
        ...
        final double y2, final double x3, final double y3)
    {
        ...
        {
            Processing.INSTANCE.directionalLight(
