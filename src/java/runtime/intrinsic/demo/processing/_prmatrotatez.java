 ...
 */
public final class _prmatrotatez extends IntrinsicLambda
{
    public static final _prmatrotatez INSTANCE = new _prmatrotatez(); 
    public static final String NAME = "prmatrotatez";
